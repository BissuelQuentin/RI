...
public class RunFileCreatorTesting {
    ...
    public static void createRun(Integer step, Integer run, String ponderation, String granularity, List<List<ScoreTesting>> result) {
        String stepNum = "";
        String runNum = "";
        if (step < 10) {
            stepNum = "0" + step;
        ...
        try {
            ...
            Logger.getLogger(RunFileCreatorTesting.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void writeInFile(File runFile, List<List<ScoreTesting>> result) throws IOException {
